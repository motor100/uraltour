...
<div class="dashboard-content">
  ...
  <form id="save-data-form" class="form" action="{{ route('dashboard.documents-update', $document->id) }}" method="post" enctype="multipart/form-data">
    <div class="form-group mb-3">
      <label for="title" class="form-label">Название</label>
      <input type="text" class="form-control" name="title" id="title" minlength="2" maxlength="250" required value="{{ $document->title }}">
    </div>
